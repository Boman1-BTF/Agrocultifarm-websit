...
export default function Page() {
  ...
  return (
    <main className="site-shell">
      ...
      <section id="contact" className="section container contact-section"><div className="contact-copy"><div className="kicker"><span className="kicker-line" /> LET&apos;S BUILD WHAT&apos;S NEXT</div><h2>Bring your boldest<br /><em>agriculture idea.</em></h2><p>Whether you are scaling a farm, sourcing better produce, or architecting the next category-defining AgTech product, we would love to hear from you.</p><div className="contact-detail"><Send size={16} /><span>agrocultifarm@gmail.com</span></div></div><form className="inquiry-form" action="https://formspree.io/f/xwlpbelp" method="POST"><div className="form-row"><label>Name<input className="bg-white text-gray-900 dark:bg-gray-900 dark:text-white" required name="name" placeholder="Your name" /></label><label>Email<input className="bg-white text-gray-900 dark:bg-gray-900 dark:text-white" required type="email" name="email" placeholder="you@company.com" /></label></div><label>Inquiry type<select className="bg-white text-gray-900 dark:bg-gray-900 dark:text-white" name="inquiry_type"><option>Agency Services</option><option>Platform Access</option><option>Investor Relations</option></select></label><label>Message<textarea className="bg-white text-gray-900 dark:bg-gray-900 dark:text-white" required name="message" rows={4} placeholder="Tell us a little about your project..." /></label><button className="button button-primary form-submit" type="submit">Send inquiry <Send size={16} /></button></form></section>
